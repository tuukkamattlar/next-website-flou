...
import { attributes as competences } from '../content/competences_list.md';
import SEO from '@components/metacomponents/SEO';
import FrontpageCompetencesTest from '@components/general_components/front_competences';
    ...
    <>
      ...
      */}
      ...
      <div>
        ...
        <FrontpageCompetencesTest lan={lan} competences={competences.category}/>
